...
**ВНИМАНИЕ:** Этот документ описывает устаревшую логику двухэтапного арбитража (`two-legged arbitrage`), которая больше не используется в проекте.

Актуальное и корректное описание текущих процессов находится в файле [**process_flow.md**](./process_flow.md).
